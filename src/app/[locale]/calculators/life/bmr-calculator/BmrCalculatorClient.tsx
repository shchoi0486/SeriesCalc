        ...
        <div>
          ...
          <ol className="space-y-4 text-sm text-muted-foreground">
            <li className="flex gap-3">
              ...
              <div><strong>성별 선택</strong> &rarr; 남성/여성을 선택합니다</div>
            </li>
            <li className="flex gap-3">
              ...
              <div><strong>신체 정보 입력</strong> &rarr; 키(cm), 체중(kg), 나이(세)를 입력합니다</div>
            </li>
            <li className="flex gap-3">
              ...
              <div><strong>활동량 선택</strong> &rarr; 일상 활동 수준(좌식~초고강도)을 선택합니다</div>
            </li>
            <li className="flex gap-3">
              ...
              <div><strong>결과 확인</strong> &rarr; 기초대사율(BMR)과 일일 소비 칼로리(TDEE)를 확인합니다</div>
            </li>
          </ol>
        </div>
      ),
      workedExamples: (
        <div>
          ...
          <div className="space-y-6 text-sm text-muted-foreground">
            <div className="p-3 bg-card rounded-md shadow-sm border border-border">
              <p className="font-semibold text-primary">예시 1: 30세 남성, 175cm, 70kg, 보통 활동</p>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                BMR = 10&times;70 + 6.25&times;175 - 5&times;30 + 5 = 1683 kcal
              </code>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                TDEE = 1683 &times; 1.55 = 2609 kcal
              </code>
            </div>
            <div className="p-3 bg-card rounded-md shadow-sm border border-border">
              <p className="font-semibold text-primary">예시 2: 25세 여성, 160cm, 55kg, 가벼운 활동</p>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                BMR = 10&times;55 + 6.25&times;160 - 5&times;25 - 161 = 1304 kcal
              </code>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                TDEE = 1304 &times; 1.375 = 1793 kcal
              </code>
            </div>
          </div>
        </div>
      ...
      faq: (
        <div>
          ...
          <div className="space-y-5 text-sm text-muted-foreground">
            <FaqItem q="BMR과 TDEE의 차이는?" a="BMR은 완전한 휴식 상태에서 소모되는 칼로리이고, TDEE는 보행, 운동, 소화 등 모든 일일 활동이 포함된 총 에너지 소비량입니다." />
            <FaqItem q="Mifflin-St Jeor 공식이 다른 공식보다 정확한 이유는?" a="연구에 따르면 Mifflin-St Jeor 공식이 약 70%의 사람들에서 측정된 기초대사율과 가장 가깝게 일치합니다." />
            <FaqItem q="활동량은 어떻게 판단하나요?" a="좌식: 사무직이며 운동 없음; 가벼운: 주 1~3회 운동; 보통: 주 3~5회; 적극적: 주 6~7회 고강도 운동; 매우 적극적: 운동선수 수준." />
            <FaqItem q="다이어트 시 BMR 이하로 먹으면 안 되나요?" a="예. BMR 이하로 섭취하면 대사율이 저하되고 근육 손실, 영양 결핍이 발생할 수 있습니다. 지속 가능한 적자는 TDEE에서 300~500kcal 정도입니다." />
            <FaqItem q="나이가 들수록 대사율이 떨어지나요?" a="20대 이후 매 10년마다 BMR은 약 1~2%씩 감소하며, 이는 주로 근육량 감소 때문입니다. 근력 운동으로 이 감소를 늦출 수 있습니다." />
          </div>
        </div>
      ),
    }
  ) : (
    {
      ...
      howToUse: (
        <div>
          ...
          <ol className="space-y-4 text-sm text-muted-foreground">
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary text-xs font-bold flex items-center justify-center">1</span>
              <div><strong>Select sex</strong> &rarr; choose Male or Female</div>
            </li>
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary text-xs font-bold flex items-center justify-center">2</span>
              <div><strong>Enter body info</strong> &rarr; input height (cm), weight (kg), and age (years)</div>
            </li>
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary text-xs font-bold flex items-center justify-center">3</span>
              <div><strong>Select activity level</strong> &rarr; choose your daily activity level (sedentary to extra active)</div>
            </li>
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary text-xs font-bold flex items-center justify-center">4</span>
              <div><strong>View results</strong> &rarr; check your Basal Metabolic Rate (BMR) and daily calorie expenditure (TDEE)</div>
            </li>
          </ol>
        </div>
      ),
      workedExamples: (
        <div>
          ...
          <div className="space-y-6 text-sm text-muted-foreground">
            <div className="p-3 bg-card rounded-md shadow-sm border border-border">
              <p className="font-semibold text-primary">Example 1: 30-year-old male, 175cm, 70kg, moderate activity</p>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                BMR = 10&times;70 + 6.25&times;175 - 5&times;30 + 5 = 1683 kcal
              </code>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
            ...
            <div className="p-3 bg-card rounded-md shadow-sm border border-border">
              <p className="font-semibold text-primary">Example 2: 25-year-old female, 160cm, 55kg, light activity</p>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                BMR = 10&times;55 + 6.25&times;160 - 5&times;25 - 161 = 1304 kcal
              </code>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
      ...
      faq: (
        <div>
          ...
          <div className="space-y-5 text-sm text-muted-foreground">
            <FaqItem q="What is the difference between BMR and TDEE?" a="BMR is calories burned at complete rest; TDEE includes all daily activities (exercise, walking, digestion etc.)." />
            <FaqItem q="Why is the Mifflin-St Jeor equation more accurate?" a="Research shows Mifflin-St Jeor most closely matches measured resting metabolic rate in ~70% of people." />
            <FaqItem q="How do I determine my activity level?" a="Sedentary: desk job no exercise; Light: exercise 1-3 days/week; Moderate: 3-5 days; Very active: 6-7 days hard exercise; Extra active: athlete-level." />
            <FaqItem q="Should I eat below my BMR to lose weight?" a="No. Eating below BMR can slow metabolism, cause muscle loss, and trigger nutritional deficiencies. Sustainable deficit is 300-500 kcal below TDEE." />
            <FaqItem q="Does metabolic rate decrease with age?" a="BMR decreases ~1-2% per decade after 20, mainly due to muscle mass loss. Resistance training can counteract this decline." />
          </div>
        </div>
      ),
    }
