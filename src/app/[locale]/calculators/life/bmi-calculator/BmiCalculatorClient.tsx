        ...
        <div>
          ...
          <ol className="space-y-4 text-sm text-muted-foreground">
            <li className="flex gap-3">
              ...
              <div><strong>키 입력</strong> &rarr; cm 단위로 키를 입력합니다 (예: 170cm)</div>
            </li>
            <li className="flex gap-3">
              ...
              <div><strong>체중 입력</strong> &rarr; kg 단위로 체중을 입력합니다 (예: 65kg)</div>
            </li>
            <li className="flex gap-3">
              ...
              <div><strong>BMI 계산</strong> &rarr; 계산 버튼을 클릭합니다</div>
            </li>
            <li className="flex gap-3">
              ...
              <div><strong>결과 확인</strong> &rarr; BMI 수치와 체중 분류(저체중/정상/과체중/비만)를 확인합니다</div>
            </li>
          </ol>
        </div>
      ),
      workedExamples: (
        <div>
          ...
          <div className="space-y-6 text-sm text-muted-foreground">
            <div className="p-3 bg-card rounded-md shadow-sm border border-border">
              <p className="font-semibold text-primary">예시 1: 170cm, 65kg</p>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                BMI = 65 &divide; (1.70)&sup2; = 65 &divide; 2.89 = 22.49
              </code>
              <p className="text-xs">결과: <strong>정상</strong> (18.5~24.9)</p>
            </div>
            <div className="p-3 bg-card rounded-md shadow-sm border border-border">
              <p className="font-semibold text-primary">예시 2: 160cm, 80kg</p>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                BMI = 80 &divide; (1.60)&sup2; = 80 &divide; 2.56 = 31.25
              </code>
              <p className="text-xs">결과: <strong>2단계 비만</strong> (30.0~)</p>
            </div>
          </div>
        </div>
      ),
      faq: (
        <div>
          ...
          <div className="space-y-5 text-sm text-muted-foreground">
            <FaqItem q="BMI가 근육량을 반영하나요?" a="아니요, BMI는 체중과 키만 고려합니다. 근육량이 많은 운동선수는 체지방이 적더라도 과체중으로 분류될 수 있습니다." />
            <FaqItem q="BMI 기준은 어떻게 다르나요?" a="WHO 기준: 저체중 &lt;18.5, 정상 18.5~24.9, 과체중 25~29.9, 비만 30 이상. 아시아 인구는 더 낮은 기준을 사용할 수 있습니다(과체중 &ge;23)." />
            <FaqItem q="어린이에게도 적용되나요?" a="직접적으로는 아닙니다. 어린이는 성장 패턴을 고려한 BMI-for-age 백분위수 차트를 사용합니다." />
            <FaqItem q="체형에 따른 차이는?" a="같은 BMI라도 체 구성이 다를 수 있습니다. 근육이 많은 사람과 운동이 부족한 사람은 같은 BMI에서 건강 위험이 다릅니다." />
            <FaqItem q="BMI 외에 추가 확인 필요한 지표는?" a="허리 둘레, 체지방률, 혈압, 혈중 지질 등을 함께 확인하면 더 나은 건강 평가가 가능합니다." />
          </div>
        </div>
      ),
    }
  ) : (
    {
      ...
      howToUse: (
        <div>
          ...
          <ol className="space-y-4 text-sm text-muted-foreground">
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary text-xs font-bold flex items-center justify-center">1</span>
              <div><strong>Enter height</strong> &rarr; input your height in cm (e.g. 170cm)</div>
            </li>
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary text-xs font-bold flex items-center justify-center">2</span>
              <div><strong>Enter weight</strong> &rarr; input your weight in kg (e.g. 65kg)</div>
            </li>
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary text-xs font-bold flex items-center justify-center">3</span>
              <div><strong>Calculate BMI</strong> &rarr; click the Calculate button</div>
            </li>
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-primary/10 text-primary text-xs font-bold flex items-center justify-center">4</span>
              <div><strong>View results</strong> &rarr; check your BMI score and weight classification (underweight/normal/overweight/obese)</div>
            </li>
          </ol>
        </div>
      ),
      workedExamples: (
        <div>
          ...
          <div className="space-y-6 text-sm text-muted-foreground">
            <div className="p-3 bg-card rounded-md shadow-sm border border-border">
              <p className="font-semibold text-primary">Example 1: 170cm, 65kg</p>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                BMI = 65 &divide; (1.70)&sup2; = 65 &divide; 2.89 = 22.49
              </code>
              <p className="text-xs">Result: <strong>Normal</strong> (18.5~24.9)</p>
            </div>
            <div className="p-3 bg-card rounded-md shadow-sm border border-border">
              <p className="font-semibold text-primary">Example 2: 160cm, 80kg</p>
              <code className="block bg-muted p-2 rounded-md my-2 text-xs">
                BMI = 80 &divide; (1.60)&sup2; = 80 &divide; 2.56 = 31.25
              </code>
              <p className="text-xs">Result: <strong>Obese (Class 2)</strong> (30.0+)</p>
            </div>
          </div>
        </div>
      ),
      faq: (
        <div>
          ...
          <div className="space-y-5 text-sm text-muted-foreground">
            <FaqItem q="Does BMI account for muscle mass?" a="No, BMI only considers weight and height. Athletes with high muscle mass may be classified as overweight despite low body fat." />
            <FaqItem q="How do BMI standards differ?" a="WHO standards: Underweight &lt;18.5, Normal 18.5-24.9, Overweight 25-29.9. Asian populations may use lower thresholds (Overweight &ge;23)." />
            <FaqItem q="Does it apply to children?" a="Not directly. Children use BMI-for-age percentile charts that account for growth patterns." />
            <FaqItem q="What about body type differences?" a="Same BMI can differ in body composition. Muscular vs sedentary individuals have different health risks at the same BMI." />
            <FaqItem q="What other indicators should I check alongside BMI?" a="Waist circumference, body fat percentage, blood pressure, and blood lipids together provide better health assessment." />
          </div>
        </div>
      ),
    }
