...
const DpsCalculator: React.FC = () => {
  ...
  const resultSection = (
    ...
    howToUse: (
      <div className="space-y-4">
        <h4 className="font-bold text-lg mb-2 border-l-4 border-border pl-3">{t.howToUse.title}</h4>
    ...
    workedExamples: (
      <div className="space-y-4">
        <h4 className="font-bold text-lg mb-2 border-l-4 border-border pl-3">{t.workedExamples.title}</h4>
        <div className="p-4 bg-muted rounded-lg border-l-4 border-primary space-y-2">
          <p>{t.workedExamples.ex1}</p>
          <p>{t.workedExamples.ex2}</p>
          <p>{t.workedExamples.ex3}</p>
        </div>
      </div>
    ),
    faq: (
      <div className="space-y-4">
        <h4 className="font-bold text-lg mb-2 border-l-4 border-border pl-3">{t.faq.title}</h4>
