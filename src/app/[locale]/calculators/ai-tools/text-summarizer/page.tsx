...
import CalculatorClient from "./TextSummarizerClient";
...
export function generateMetadata({
  ...
  return buildCalculatorMetadata(params.locale, "/calculators/ai-tools/text-summarizer", "ai-tools", "text-summarizer");
}
