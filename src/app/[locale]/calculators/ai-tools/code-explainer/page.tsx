...
import CalculatorClient from "./CodeExplainerClient";
...
export function generateMetadata({
  ...
  return buildCalculatorMetadata(params.locale, "/calculators/ai-tools/code-explainer", "ai-tools", "code-explainer");
}
