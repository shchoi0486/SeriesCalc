...
import CalculatorClient from "./PromptGeneratorClient";
...
export function generateMetadata({
  ...
  return buildCalculatorMetadata(params.locale, "/calculators/ai-tools/prompt-generator", "ai-tools", "prompt-generator");
}
