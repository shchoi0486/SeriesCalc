    ...
    calculationFormula: (
      <div className="text-base leading-relaxed space-y-6">
        ...
        <div className="p-4 bg-muted rounded-lg border-l-4 border-primary">
          ...
          <BlockMath math={isKo ? "\\text{월 상환 원금} = \\dfrac{\\text{총 대출 원금}}{\\text{상환 개월 수}}" : "\\text{Monthly Principal} = \\dfrac{\\text{Total Loan Principal}}{\\text{Number of Months}}"} />
        ...
        <div className="p-4 bg-muted rounded-lg border-l-4 border-primary">
          ...
          <BlockMath math={isKo ? "\\text{월 상환 이자} = \\text{전월 대출 잔액} \\times \\text{월 이자율}\\left(\\dfrac{\\text{연이율}}{12}\\right)" : "\\text{Monthly Interest} = \\text{Previous Balance} \\times \\text{Monthly Rate}\\left(\\dfrac{\\text{Annual Rate}}{12}\\right)"} />
        ...
        <div className="p-4 bg-muted rounded-lg border-l-4 border-primary">
          ...
          <BlockMath math={isKo ? "\\text{월 총 상환금} = \\text{월 상환 원금(고정)} + \\text{월 상환 이자(변동)}" : "\\text{Monthly Total} = \\text{Monthly Principal (fixed)} + \\text{Monthly Interest (variable)}"} />
