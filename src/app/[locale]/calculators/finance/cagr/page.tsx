    ...
    calculatorDescription: (
      <>
        ...
        <p className="mt-4 text-foreground">
          {isKo ? "SeriesCalc의 CAGR 계산기는 주식, 펀드, 부동산, 암호화폐 등 다양한 자산의 성과를 객관적으로 평가하고, 여러 투자 대안을 동일한 기준으로 비교할 수 있도록 돕습니다. 더 나아가 기업의 매출 성장률, 사용자 증가 추이 등 비즈니스 성과를 분석하는 데에도 핵심적인 지표로 활용될 수 있습니다. 이제 복잡한 계산은 저희에게 맡기고, 당신은 데이터가 말해주는 통찰에만 집중하세요." : "SeriesCalc's CAGR calculator objectively evaluates the performance of various assets—stocks, funds, real estate, crypto—and lets you compare investment alternatives on the same basis. It can also serve as a key metric for analyzing business performance such as revenue growth and user growth trends. Leave the complex math to us and focus on the insights the data reveals."}
