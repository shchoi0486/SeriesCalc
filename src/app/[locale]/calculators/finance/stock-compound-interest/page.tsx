  ...
  const infoSection = {
    calculatorDescription: (
      <div className="space-y-4">
        ...
        <p>물론, 투자의 세계는 불확실성으로 가득 차 있습니다. 이 계산기는 과거의 데이터나 사용자가 설정한 기대 수익률을 기반으로 한 예측이며, 미래의 수익을 보장하지는 않습니다. 하지만 꾸준한 투자와 시간의 힘이 만나 만들어내는 복리의 마법을 이해하는 것만으로도 당신의 금융 여정에 훌륭한 나침반이 될 것입니다.</p>        <TermGlossary items={[
          { term: '복리 (Compound Interest)', desc: '발생한 수익을 원금에 합산하여 재투자함으로써, 시간이 지날수록 자산이 기하급수적으로 증식하는 원리입니다.' },
          { term: '적립식 투자 (DCA)', desc: '일정한 주기마다 정해진 금액을 투자하여 평균 매수 단가를 낮추는 전략으로, 시장 타이밍 위험을 줄여줍니다.' },
          { term: '실질 수익률', desc: '명목 수익률에서 물가상승률(인플레이션)을 뺀 실질적인 구매력 증가분을 의미합니다.' },
        ]} />
