        ...
        calculationFormula: (
          <>
            ...
            <div className="mt-4 p-6 bg-muted rounded-lg text-center shadow-inner overflow-x-auto">
              {isKo ? <BlockMath math="\text{연차수당} = \text{1일 통상임금} \times \text{잔여 연차일수}" /> : <BlockMath math="\text{Leave Pay} = \text{Daily Ordinary Wage} \times \text{Remaining Leave Days}" />}
            </div>
