...
export const ko: Dictionary = {
  common: {
    ...
    reynoldsNumber: {
      ...
      visualization: {
        title: '유동 특성 시각화',
        regimeBar: '레이놀즈 수 눈금 (로그)',
        laminarZone: '층류',
        transitionalZone: '천이',
        turbulentZone: '난류',
        currentPosition: '현재 Re',
        flowDiagram: '흐름 패턴',
      },
      units: {
        density: '밀도 단위',
    ...
    bearingLife: {
      ...
      visualization: {
        title: '베어링 수명-부하 곡선',
        caption: '파란 곡선: 베어링 수명(L10h, 시간)이 부하 증가에 따라 감소. 빨간 점: 현재 운전점으로, 그 높이가 L10h 결과와 일치.',
      },
      details: {
  ...
  home: {
    title: '필요한 계산기, 모두 한곳에',
    subtitle:
      '금융, 건강, 일상, 엔지니어링 등 다양한 분야의 계산기를 바로 이용해 보세요.',
    press: '프레스',
    about: 'SeriesCalc 소개',
  },
  footer: {
  ...
  categories: {
    ...
    finance: {
      name: '금융',
      description: '금융 계산기로 투자 계획을 세우고 이자와 절약액을 확인해 보세요. 각 계산기에는 관련 금융 정보와 계산 공식이 함께 제공됩니다.',
    },
    conversion: {
      name: '변환',
      description: '다양한 단위를 손쉽게 변환해 보세요. 길이, 무게, 부피, 에너지, 전력, 환율, 시간대 등 일상에서 필요한 모든 변환을 빠르고 정확하게 처리할 수 있습니다.',
    },
    life: {
      name: '일상',
      description: '건강, 시간, 쇼핑 등 일상생활과 관련된 다양한 계산기를 제공합니다. 계산기로 건강한 습관을 계획하고 시간을 효율적으로 관리하며 똑똑한 소비를 실천해 보세요.',
    },
    science: {
      name: '과학',
    ...
    engineering: {
      name: '엔지니어링',
      description: '유체 역학, 재료 분석 등 다양한 공학 분야의 계산기를 제공합니다. 복잡한 공학 문제를 해결하고 설계 및 분석 작업을 효율적으로 수행해 보세요.',
    },
    'ai-tools': {
      name: 'AI 도구',
  ...
  calculatorNames: {
    ...
    'dsr-calculator': 'DSR 계산기',
    'amortization-schedule': '상환 스케줄 계산기',
    'auto-loan-calculator': '자동차 대출 계산기',
    'jeonse-deposit-calculator': '전세보증금 대출 한도',
    'charter-loan-calculator': '전세자금대출 계산기',
    'net-salary-calculator': '실수령액 계산기',
    'salary-calculator': '연봉 변환 계산기',
    'income-tax-calculator': '소득세 계산기',
    'inflation-calculator': '물가상승률 계산기',
    'interest-rate-calculator': '이자율 변환 계산기',
    'korean-shoe-size-converter': '한국 신발 사이즈 변환',
    'korean-clothing-size-converter': '한국 의류 사이즈 변환',
    'calorie-calculator': '칼로리 계산기',
    'body-fat-calculator': '체지방율 계산기',
    'ideal-weight-calculator': '이상체중 계산기',
    'pace-calculator': '페이스 계산기',
    'due-date-calculator': '출산 예정일 계산기',
    'time-calculator': '시간 덧셈/뺄셈',
    'hours-calculator': '근무시간 계산기',
    'sales-tax-calculator': '부가세 포함 가격 계산기',
    'moving-cost-calculator': '이사 비용 계산기',
    'gpa-calculator': 'GPA 계산기 (한국 4.5)',
    'percentage-calculator': '퍼센트 계산기',
    'fraction-calculator': '분수 계산기',
    'triangle-calculator': '삼각형 계산기',
    'standard-deviation-calculator': '표준편차 계산기',
    'korean-wind-load': '한국 풍하중 계산기 (KDS)',
    'subnet-calculator': '서브넷 계산기',
    'pressure-converter': '압력 단위 변환기',
    'flow-rate-converter': '유량 단위 변환기',
    'water-density': '물 밀도 계산기',
    'specific-gravity': '비중 계산기',
    'pipe-sizing': '배관 사이즈 계산기',
    'wire-gauge': '와이어 게이지 (AWG) 계산기',
    'moment-of-inertia': '단면 2차 모멘트 계산기',
    'heat-capacity': '열용량 계산기',
    'dew-point': '이슬점 계산기',
    'convection-heat-transfer': '대류 열전달 계수 계산기',
  },
  calculatorDescriptions: {
    ...
    'pressure-converter': 'Pa, bar, atm, psi, mmHg 등 압력 단위를 상호 변환합니다.',
    'flow-rate-converter': 'm³/h, L/min, gal/min, CFM 등 유량 단위를 상호 변환합니다.',
    'water-density': '온도에 따른 물의 밀도, 비중량 및 점도를 계산합니다.',
    'specific-gravity': '물 대비 특정 물질의 비중을 계산합니다.',
    'pipe-sizing': '유량과 최대 유속을 기준으로 최적의 배관 직경을 결정합니다.',
    'wire-gauge': 'AWG 와이어 게이지의 치수, 단면적 및 단위 길이당 저항을 조회합니다.',
    'moment-of-inertia': '다양한 단면에 대한 단면 2차 모멘트(관성 모멘트)를 계산합니다.',
    'heat-capacity': '물질의 온도를 변화시키는 데 필요한 열에너지를 계산합니다.',
    'dew-point': '건구 온도와 상대습도를 기준으로 이슬점, 습구 온도 및 절대 습도를 계산합니다.',
    'convection-heat-transfer': '레이놀즈 수와 누셀트 수를 사용하여 대류 열전달 계수를 계산합니다.',
  },
  calculatorLayout: {
    inputInfo: '정보 입력',
    result: '계산 결과',
  ...
  earlyRepaymentFee: {
    ...
    descriptionContent: '<p class="text-muted-foreground">목돈이 생겨 대출금을 미리 갚아 이자 부담을 덜어내려는 순간, \'중도상환수수료\'라는 예상치 못한 지출과 마주할 수 있습니다. 중도상환수수료는 금융기관과의 약속된 대출 기간을 채우지 못하고 원금을 미리 상환할 때 발생하는 위약금입니다.</p><p class="mt-4 text-muted-foreground">은행과 같은 금융기관은 고객의 대출 기간 동안 발생할 이자 수익을 예측하고, 이를 바탕으로 자금을 조달하고 운용하는 복잡한 계획을 세웁니다. 하지만 고객이 예상보다 일찍 대출금을 상환하면, 계획했던 이자 수익을 얻지 못할 뿐만 아니라 갑자기 들어온 목돈을 즉시 효율적인 곳에 재투자하기 어렵습니다. 이 과정에서 발생하는 기회비용과 행정적 비용을 보전하기 위해 중도상환수수료가 존재합니다.</p><p class="mt-4 text-muted-foreground">일반적으로 대출 실행일로부터 <strong class="text-foreground">3년 이내</strong>에 원금을 상환할 경우 수수료가 부과되며, 수수료율은 금융기관, 대출 상품, 약정 조건에 따라 0.5%에서 1.5%까지 다양하게 적용됩니다. 변동금리 대출이 고정금리 대출보다 수수료율이 낮은 경향이 있으며, 최근에는 인터넷 은행을 중심으로 중도상환수수료 면제 상품도 등장하고 있습니다.</p><p class="mt-4 text-muted-foreground"><strong class="text-foreground">SeriesCalc의 중도상환수수료 계산기</strong>는 이러한 복잡한 조건 속에서 당신의 현명한 의사결정을 돕는 강력한 도구입니다. 단순히 수수료를 계산하는 것을 넘어, 상환 시점에 따른 유불리를 따져보고, 불필요한 지출을 막는 최적의 재무 전략을 세울 수 있도록 돕습니다.</p>',
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">중도상환수수료, 어떻게 계산될까요?</h3><p class="text-base leading-relaxed mb-6 text-muted-foreground">현재 국내 대부분의 금융기관은 시간이 지남에 따라 수수료 부담이 점차 줄어드는 <strong class="text-foreground">\'슬라이딩 방식\'</strong>을 사용합니다. 대출 만기가 많이 남았을수록 높은 수수료를, 만기에 가까워질수록 낮은 수수료를 내는 합리적인 구조입니다.</p><div class="mt-4 p-6 bg-muted rounded-lg text-center border border-border"><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>예상 수수료</mtext><mo>=</mo><mtext>중도상환원금</mtext><mo>×</mo><mtext>수수료율</mtext><mo>×</mo><mfrac><mtext>잔여일수</mtext><mtext>부과기간</mtext></mfrac></mrow><annotation encoding="application/x-tex">\\text{예상 수수료} = \\text{중도상환원금} \\times \\text{수수료율} \\times \\dfrac{\\text{잔여일수}}{\\text{부과기간}}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">예상</span><span class="mord"> </span><span class="mord hangul_fallback">수수료</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">중도상환원금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">수수료율</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.0463em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3603em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">부과기간</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">잔여일수</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div></div><div class="mt-8 space-y-6"><div><h4 class="text-lg font-semibold text-foreground">① 중도상환원금</h4><p class="mt-2 text-base leading-relaxed text-muted-foreground">만기 전에 미리 갚으려는 대출 원금을 의미합니다. 갚으려는 금액이 클수록 당연히 수수료도 함께 증가합니다.</p></div><div><h4 class="text-lg font-semibold text-foreground">② 중도상환수수료율</h4><p class="mt-2 text-base leading-relaxed text-muted-foreground">대출 약정 시 정해진 비율로, 보통 연 단위(%)로 표시됩니다. 일반적으로 1.0% ~ 1.4% 사이에서 책정됩니다.</p></div><div><h4 class="text-lg font-semibold text-foreground">③ 잔여기간 / 부과기간 (슬라이딩 방식의 핵심)</h4><p class="mt-2 text-base leading-relaxed text-muted-foreground">실제 총 대출 기간과 상관없이, 수수료가 부과되는 기간은 보통 <strong class="text-foreground">3년(1,095일)</strong>으로 한정됩니다. 대출받은 지 3년이 지나면 중도상환수수료는 0원이 됩니다.</p></div></div><div class="mt-8 p-6 border-l-4 border-primary bg-muted rounded-r-lg"><h4 class="font-bold text-lg mb-3 text-foreground">실제 계산 예시</h4><p class="text-base text-muted-foreground">- 총 대출금: 3억 원 (30년 만기 주택담보대출)<br/>- 중도상환수수료율: 1.2%<br/>- 상환 시점: 대출 실행 후 1년 6개월 (548일) 뒤<br/>- 상환 희망 원금: 5,000만 원</p><p class="mt-4 font-mono bg-card p-4 rounded-md text-sm border border-border"><strong class="text-foreground">1. 수수료 부과 잔여일수:</strong> 1,095일 - 548일 = 547일<br/><br/><strong class="text-foreground">2. 최종 수수료:</strong> 50,000,000원 × 1.2% × (547일 ÷ 1,095일) = <strong class="text-primary">약 299,726원</strong></p></div>',
  ...
  installmentInterest: {
    ...
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">할부 이자, 어떻게 계산될까?</h3><p class="text-muted-foreground">원리금 균등 분할 상환 방식은 매달 갚는 돈(월 상환금)이 할부 기간 내내 동일하다는 특징이 있습니다.</p><div class="p-6 bg-card rounded-lg my-4 border border-border"><h4 class="text-lg font-semibold mb-3 text-foreground">원리금 균등 상환 월 상환금 공식</h4><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>월 상환금</mtext><mo>=</mo><mfrac><mrow><mtext>원금</mtext><mo>×</mo><mtext>월이율</mtext><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>월이율</mtext><msup><mo stretchy="false">)</mo><mtext>개월수</mtext></msup></mrow><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>월이율</mtext><msup><mo stretchy="false">)</mo><mtext>개월수</mtext></msup><mo>−</mo><mn>1</mn></mrow></mfrac></mrow><annotation encoding="application/x-tex">\\text{월 상환금} = \\dfrac{\\text{원금} \\times \\text{월이율} \\times (1 + \\text{월이율})^{\\text{개월수}}}{(1 + \\text{월이율})^{\\text{개월수}} - 1}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">월</span><span class="mord"> </span><span class="mord hangul_fallback">상환금</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:2.4543em;vertical-align:-0.936em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.5183em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord hangul_fallback">월이율</span></span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.7673em;"><span style="top:-2.989em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord text mtight"><span class="mord hangul_fallback mtight">개월수</span></span></span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">원금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord hangul_fallback">월이율</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord hangul_fallback">월이율</span></span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.8413em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord text mtight"><span class="mord hangul_fallback mtight">개월수</span></span></span></span></span></span></span></span></span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.936em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>총 이자</mtext><mo>=</mo><mo stretchy="false">(</mo><mtext>월 상환금</mtext><mo>×</mo><mtext>개월수</mtext><mo stretchy="false">)</mo><mo>−</mo><mtext>원금</mtext></mrow><annotation encoding="application/x-tex">\\text{총 이자} = (\\text{월 상환금} \\times \\text{개월수}) - \\text{원금}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">총</span><span class="mord"> </span><span class="mord hangul_fallback">이자</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord text"><span class="mord hangul_fallback">월</span><span class="mord"> </span><span class="mord hangul_fallback">상환금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord hangul_fallback">개월수</span></span><span class="mclose">)</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">원금</span></span></span></span></span></span></div></div><div class="p-6 bg-muted rounded-lg border border-border"><h4 class="text-lg font-semibold mb-3 text-foreground">예시로 쉽게 이해하기</h4><p class="text-muted-foreground">100만원짜리 노트북을 연 12% 이자율로 12개월 할부 구매했다면?</p><ul class="list-decimal list-inside space-y-2 mt-3 text-sm text-muted-foreground"><li><strong class="text-foreground">원금:</strong> 1,000,000원</li><li><strong class="text-foreground">월이율:</strong> 12% / 12 = 1% (0.01)</li><li><strong class="text-foreground">월 상환금:</strong> ≈ 88,849원</li><li><strong class="text-foreground">총 상환액:</strong> 1,066,188원</li><li><strong class="text-foreground">총 이자:</strong> 66,188원</li></ul></div>',
  ...
  compoundInterest: {
    ...
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">복리 계산, 어떻게 이루어지나요?</h3><div class="space-y-4"><div class="p-4 border-l-4 border-primary bg-muted"><h4 class="font-semibold text-lg mb-2">1. 거치식 투자 (월 적립금 없는 경우)</h4><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>미래가치(FV)</mtext><mo>=</mo><mtext>원금(P)</mtext><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>월이율</mtext><msup><mo stretchy="false">)</mo><mtext>개월수</mtext></msup></mrow><annotation encoding="application/x-tex">\\text{미래가치(FV)} = \\text{원금(P)} \\times (1 + \\text{월이율})^{\\text{개월수}}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord hangul_fallback">미래가치</span><span class="mord">(FV)</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord hangul_fallback">원금</span><span class="mord">(P)</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1.1413em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord hangul_fallback">월이율</span></span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.8913em;"><span style="top:-3.113em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord text mtight"><span class="mord hangul_fallback mtight">개월수</span></span></span></span></span></span></span></span></span></span></span></span></span></span></div></div><div class="p-4 border-l-4 border-primary bg-muted"><h4 class="font-semibold text-lg mb-2">2. 적립식 투자 (월 적립금 있는 경우)</h4><div class="my-2 overflow-x-auto"><p class="mb-1 text-sm"><strong>월초 납입 시:</strong></p><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>F</mi><mi>V</mi><mo>=</mo><mtext>거치식 FV</mtext><mo>+</mo><mi>M</mi><mo>×</mo><mfrac><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><msup><mo stretchy="false">)</mo><mi>n</mi></msup><mo>−</mo><mn>1</mn></mrow><mi>r</mi></mfrac><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">FV = \\text{거치식 FV} + M \\times \\dfrac{(1+r)^n - 1}{r} \\times (1+r)</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.13889em;">F</span><span class="mord mathnormal" style="margin-right:0.22222em;">V</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">거치식</span><span class="mord"> FV</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal" style="margin-right:0.10903em;">M</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.113em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.427em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.6644em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">n</span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose">)</span></span></span></span></span></div><div class="my-2 overflow-x-auto"><p class="mb-1 text-sm"><strong>월말 납입 시:</strong></p><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>F</mi><mi>V</mi><mo>=</mo><mtext>거치식 FV</mtext><mo>+</mo><mi>M</mi><mo>×</mo><mfrac><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><msup><mo stretchy="false">)</mo><mi>n</mi></msup><mo>−</mo><mn>1</mn></mrow><mi>r</mi></mfrac></mrow><annotation encoding="application/x-tex">FV = \\text{거치식 FV} + M \\times \\dfrac{(1+r)^n - 1}{r}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.13889em;">F</span><span class="mord mathnormal" style="margin-right:0.22222em;">V</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">거치식</span><span class="mord"> FV</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal" style="margin-right:0.10903em;">M</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.113em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.427em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.6644em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">n</span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><p class="text-sm text-muted-foreground">월초에 납입하면 한 달치 이자를 더 받기 때문에 월말보다 최종 금액이 약간 더 커집니다.</p></div></div>',
  ...
  weeklyHoliday: {
    ...
    formulaContent: '<div className="space-y-4 p-4 bg-muted rounded-md"><h3 className="text-xl font-bold">내 주휴수당, 어떻게 계산될까?</h3><p>주휴수당은 1주일간의 소정근로시간에 비례하여 계산됩니다. 법정 최대 근로시간인 주 40시간을 기준으로 내가 일한 시간의 비율만큼 수당이 발생한다고 이해하면 쉽습니다.</p><div className="border-l-4 border-primary pl-4 mt-4"><p><strong>계산 공식:</strong></p><div class="mt-1 bg-card p-2 rounded overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mfrac><mtext>1주일 총 소정근로시간</mtext><mtext>40시간</mtext></mfrac><mo>×</mo><mtext>8시간</mtext><mo>×</mo><mtext>시급</mtext></mrow><annotation encoding="application/x-tex">\\dfrac{\\text{1주일 총 소정근로시간}}{\\text{40시간}} \\times \\text{8시간} \\times \\text{시급}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:2.0463em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3603em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">40</span><span class="mord hangul_fallback">시간</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">1</span><span class="mord hangul_fallback">주일</span><span class="mord"> </span><span class="mord hangul_fallback">총</span><span class="mord"> </span><span class="mord hangul_fallback">소정근로시간</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord">8</span><span class="mord hangul_fallback">시간</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">시급</span></span></span></span></span></span></div></div><div className="mt-4"><h4 className="font-semibold">계산 예시:</h4><p>예를 들어, 시급 10,000원을 받고 하루 6시간씩 주 4일(총 24시간)을 일하는 근로자의 경우:</p><p className="pl-4 mt-1 bg-card p-2 rounded font-mono"><code>(24시간 / 40시간) × 8시간 × 10,000원 = 48,000원</code></p><p className="text-sm text-muted-foreground mt-1">따라서 이 근로자는 1주일 급여(24시간 × 10,000원 = 240,000원) 외에 주휴수당 48,000원을 추가로 받아 총 288,000원을 받게 됩니다.</p></div><p className="text-xs text-muted-foreground mt-4">* 참고: 주 40시간 이상 일해도 주휴수당은 최대 8시간분(주 40시간 기준)까지만 지급됩니다.</p></div>',
  ...
  depositInterest: {
    ...
    descriptionContent: '<h2 className="text-2xl font-bold text-foreground mb-4">정기예금 이자 계산기: 잠자는 내 돈, 확실하게 깨우는 법</h2><p className="text-lg text-muted-foreground mb-6">재테크의 가장 기본은 \'잃지 않는 것\'에서 시작합니다. 그런 의미에서 <strong>예금</strong>은 변동성이 큰 투자 시장 속에서 여러분의 자산을 가장 안전하게 지키고, 꾸준히 불려 나갈 수 있는 가장 확실하고 안정적인 재테크 수단입니다. 특히 목돈을 일정 기간 묶어두고 약속된 이자를 받는 <strong>정기예금</strong>은 종잣돈을 마련하거나, 주택 계약금, 여행 자금 등 단기적인 금융 목표를 달성하는 데 매우 효과적입니다.</p><p className="text-foreground leading-relaxed">하지만 같은 금액을 예치하더라도 이자를 계산하는 방식(단리/복리)과 세금(과세/비과세) 적용 여부에 따라 만기 시 손에 쥐게 되는 금액은 크게 달라질 수 있습니다. 많은 사람들이 "연 3.5% 금리"라는 말만 믿고 예금에 가입했다가, 만기 후 세금을 떼고 난 실제 수령액을 보고 실망하는 경우가 많습니다. 복잡한 계산 과정 때문에 자신의 최종 수령액을 정확히 예측하는 데 어려움을 겪기 때문입니다.</p><p className="mt-4 text-foreground leading-relaxed"><strong>SeriesCalc의 예금 이자 계산기</strong>는 이러한 불편함을 해결하기 위해 만들어졌습니다. 예치할 금액, 기간, 금리만 입력하면, 복잡한 이자 계산과 세금까지 모두 고려하여 만기 시 받게 될 실수령액을 쉽고 빠르게 확인할 수 있습니다. 이 계산기를 통해 아래 질문들에 대한 명확한 답을 얻을 수 있습니다.</p><ul className="list-disc list-inside mt-4 space-y-2 text-foreground bg-muted p-4 rounded-lg"><li>단리와 복리, 어떤 방식이 나에게 더 유리할까?</li><li>내 소중한 이자에서 세금은 얼마나 빠져나갈까? (2025년 기준)</li><li>비과세나 세금우대 혜택을 받으면 얼마나 더 받을 수 있을까?</li><li>1년 만기 예금과 2년 만기 예금의 실제 수령액 차이는 얼마나 될까?</li></ul><p className="mt-6 text-foreground leading-relaxed">이제 막연한 기대 대신, 정확한 숫자를 통해 미래를 계획하세요. SeriesCalc과 함께라면 안정적인 자산 증식의 첫걸음이 더욱 쉽고 명확해집니다.</p>',
    formulaContent: '<h3 className="text-xl font-bold text-foreground mt-8 mb-4">💰 단리 vs 복리, 이자는 어떻게 계산될까?</h3><p className="text-foreground leading-relaxed mb-6">예금 이자를 계산하는 방식은 크게 단리와 복리로 나뉩니다. 어떤 방식을 선택하느냐에 따라, 특히 예치 기간이 길어질수록 만기 수령액에 상당한 차이가 발생합니다. 두 방식의 차이점을 명확히 이해하는 것이 중요합니다.</p><div className="space-y-6"><div className="p-4 pl-0 border-l-4 border-primary bg-muted rounded-r-lg"><h4 className="font-semibold text-lg mb-2 text-primary">1. 단리 (Simple Interest)</h4><p className="text-muted-foreground mb-3">오직 <strong>처음 예치한 원금</strong>에 대해서만 약속된 이자를 계산하는 방식입니다. 이자가 발생하더라도 이를 원금에 포함시키지 않기 때문에, 매번 동일한 금액의 이자가 발생합니다. 계산이 단순하고 이해하기 쉽다는 특징이 있습니다.</p><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>세전 이자</mtext><mo>=</mo><mtext>원금</mtext><mo>×</mo><mtext>연이율</mtext><mo>×</mo><mfrac><mtext>예치 개월 수</mtext><mn>12</mn></mfrac></mrow><annotation encoding="application/x-tex">\\text{세전 이자} = \\text{원금} \\times \\text{연이율} \\times \\dfrac{\\text{예치 개월 수}}{12}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">세전</span><span class="mord"> </span><span class="mord hangul_fallback">이자</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">원금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">연이율</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.0463em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3603em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord">12</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">예치</span><span class="mord"> </span><span class="mord hangul_fallback">개월</span><span class="mord"> </span><span class="mord hangul_fallback">수</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div></div><div className="p-4 pl-0 border-l-4 border-primary bg-muted rounded-r-lg"><h4 className="font-semibold text-lg mb-2 text-primary">2. 월복리 (Monthly Compound Interest)</h4><p className="text-muted-foreground mb-3">발생한 이자를 <strong>원금에 합산</strong>하고, 그 합산된 금액을 새로운 원금으로 간주하여 다음 기간의 이자를 계산하는 방식입니다. 이자가 이자를 낳는 구조로, 시간이 지날수록 이자가 기하급수적으로 늘어나는 \'눈덩이 효과\'를 기대할 수 있습니다.</p><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>세전 이자</mtext><mo>=</mo><mtext>원금</mtext><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>월이율</mtext><msup><mo stretchy="false">)</mo><mtext>예치 개월 수</mtext></msup><mo>−</mo><mtext>원금</mtext></mrow><annotation encoding="application/x-tex">\\text{세전 이자} = \\text{원금} \\times (1 + \\text{월이율})^{\\text{예치 개월 수}} - \\text{원금}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">세전</span><span class="mord"> </span><span class="mord hangul_fallback">이자</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">원금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1.1413em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord hangul_fallback">월이율</span></span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.8913em;"><span style="top:-3.113em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord text mtight"><span class="mord hangul_fallback mtight">예치</span><span class="mord mtight"> </span><span class="mord hangul_fallback mtight">개월</span><span class="mord mtight"> </span><span class="mord hangul_fallback mtight">수</span></span></span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">원금</span></span></span></span></span></span></div><p className="text-xs text-muted-foreground text-center">* 월이율 = 연이율 / 12</p></div></div><h3 className="text-xl font-bold text-foreground mt-10 mb-4">💸 최종 수령액을 결정하는 \'세금\' (2025년 기준)</h3><p className="text-foreground leading-relaxed">예금 이자는 \'이자소득\'으로 분류되어 세금이 부과됩니다. 따라서 최종 수령액은 세전 이자에서 세금을 제외한 금액이 됩니다. 과세 옵션에 따라 공제되는 세율이 다르므로, 자신에게 적용되는 세율을 정확히 아는 것이 중요합니다.</p><div className="bg-muted p-4 rounded-md my-4 border border-border border-border"><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>세후 수령액</mtext><mo>=</mo><mtext>원금</mtext><mo>+</mo><mtext>세전 이자</mtext><mo>−</mo><mtext>세전 이자</mtext><mo>×</mo><mtext>세율</mtext></mrow><annotation encoding="application/x-tex">\\text{세후 수령액} = \\text{원금} + \\text{세전 이자} - \\text{세전 이자} \\times \\text{세율}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">세후</span><span class="mord"> </span><span class="mord hangul_fallback">수령액</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">원금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">세전</span><span class="mord"> </span><span class="mord hangul_fallback">이자</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">세전</span><span class="mord"> </span><span class="mord hangul_fallback">이자</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">세율</span></span></span></span></span></span></div></div><ul className="list-disc pl-5 mt-6 space-y-4 text-foreground"><li><strong>일반과세 (15.4%):</strong> 대부분의 금융상품에 적용되는 기본 세율입니다. 이자소득의 15.4%가 세금으로 원천징수됩니다. (소득세 14% + 지방소득세 1.4%)</li><li><strong>세금우대 (9.5%):</strong> 상호금융기관(농협, 수협, 신협, 새마을금고 등)의 조합원 또는 준조합원인 경우, 1인당 3,000만원 한도 내의 예탁금에 대해 낮은 세율을 적용받을 수 있습니다. (이자소득세 면제, 농어촌특별세 1.4%만 부과) 2025년 현재 이 제도가 유지되고 있으나, 정책 변경 가능성에 유의해야 합니다.</li><li><strong>비과세 (0%):</strong> 만 65세 이상 노인, 장애인, 독립유공자 등이 가입하는 \'비과세 종합저축\'은 1인당 5,000만원 한도 내에서 이자소득에 대한 세금이 완전히 면제됩니다. 절세 혜택이 가장 크므로, 자격이 된다면 반드시 활용해야 합니다.</li></ul>',
  ...
  retirement: {
    ...
    formulaContent: '<p className="font-semibold">퇴직금은 \'1일 평균임금\'을 기준으로 \'총 재직일수\'에 비례하여 산정됩니다. 계산의 핵심 두 가지 요소를 정확히 이해하는 것이 중요합니다.</p><div className="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 className="text-lg font-bold text-primary mb-3">1. 1일 평균임금 산정</h3><p>퇴직일 이전 3개월 동안 지급된 임금 총액을 그 기간의 총 일수로 나눈 금액입니다. 여기에는 기본급뿐만 아니라 연장, 야간, 휴일근로수당 등과 같은 각종 수당이 포함됩니다.</p><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>1일 평균임금</mtext><mo>=</mo><mfrac><mrow><mtext>퇴직 전 3개월 임금 총액</mtext><mo>+</mo><mtext>연간 상여금</mtext><mo>×</mo><mstyle displaystyle="false" scriptlevel="0"><mfrac><mn>3</mn><mn>12</mn></mfrac></mstyle><mo>+</mo><mtext>연차수당</mtext><mo>×</mo><mstyle displaystyle="false" scriptlevel="0"><mfrac><mn>3</mn><mn>12</mn></mfrac></mstyle></mrow><mtext>퇴직 전 3개월 총 일수</mtext></mfrac></mrow><annotation encoding="application/x-tex">\\text{1일 평균임금} = \\dfrac{\\text{퇴직 전 3개월 임금 총액} + \\text{연간 상여금} \\times \\tfrac{3}{12} + \\text{연차수당} \\times \\tfrac{3}{12}}{\\text{퇴직 전 3개월 총 일수}}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord">1</span><span class="mord hangul_fallback">일</span><span class="mord"> </span><span class="mord hangul_fallback">평균임금</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:2.2661em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.5801em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">퇴직</span><span class="mord"> </span><span class="mord hangul_fallback">전</span><span class="mord"> 3</span><span class="mord hangul_fallback">개월</span><span class="mord"> </span><span class="mord hangul_fallback">총</span><span class="mord"> </span><span class="mord hangul_fallback">일수</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.735em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">퇴직</span><span class="mord"> </span><span class="mord hangul_fallback">전</span><span class="mord"> 3</span><span class="mord hangul_fallback">개월</span><span class="mord"> </span><span class="mord hangul_fallback">임금</span><span class="mord"> </span><span class="mord hangul_fallback">총액</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord hangul_fallback">연간</span><span class="mord"> </span><span class="mord hangul_fallback">상여금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.8451em;"><span style="top:-2.655em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">12</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.394em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">3</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.345em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord hangul_fallback">연차수당</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.8451em;"><span style="top:-2.655em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">12</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.394em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">3</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.345em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><p className="text-xs text-muted-foreground dark:text-muted-foreground mt-2">※ 상여금, 연차수당 등 1년 단위로 지급된 임금은 3개월분으로 환산하여 포함합니다.</p><p className="text-xs text-primary mt-2">※ 1일 평균임금이 통상임금보다 적을 경우, 통상임금을 1일 평균임금으로 하여 계산해야 합니다.</p></div><div className="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 className="text-lg font-bold text-primary mb-3">2. 예상 퇴직금 계산</h3><p>산정된 1일 평균임금에 30일을 곱하여 \'30일분 평균임금\'을 구하고, 이를 총 재직기간에 비례하여 최종 퇴직금을 계산합니다.</p><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>예상 퇴직금</mtext><mo>=</mo><mtext>1일 평균임금</mtext><mo>×</mo><mtext>30일</mtext><mo>×</mo><mfrac><mtext>총 재직일수</mtext><mtext>365일</mtext></mfrac></mrow><annotation encoding="application/x-tex">\\text{예상 퇴직금} = \\text{1일 평균임금} \\times \\text{30일} \\times \\dfrac{\\text{총 재직일수}}{\\text{365일}}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">예상</span><span class="mord"> </span><span class="mord hangul_fallback">퇴직금</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord">1</span><span class="mord hangul_fallback">일</span><span class="mord"> </span><span class="mord hangul_fallback">평균임금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord">30</span><span class="mord hangul_fallback">일</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.0463em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3603em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">365</span><span class="mord hangul_fallback">일</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">총</span><span class="mord"> </span><span class="mord hangul_fallback">재직일수</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><div className="mt-4 p-4 bg-muted rounded-lg border border-border"><h4 className="font-semibold text-foreground mb-2">계산 예시 (1일 평균임금 100,000원, 근속 5년)</h4><p className="text-sm text-muted-foreground">총 재직일수 = 365 × 5 = 1,825일</p><p className="font-mono text-sm text-primary mt-1">예상 퇴직금 = 100,000 × 30 × (1,825 / 365) = 100,000 × 30 × 5 = 15,000,000원</p></div></div>',
  ...
  installmentSavingsMonthly: {
    ...
    fullTitle: '상세 분석',
    descriptionContent: '<p class="text-muted-foreground"><strong>월 복리 적금</strong>은 복리의 마법을 활용하는 가장 기본적이면서도 강력한 금융 도구입니다. 워렌 버핏은 복리를 "세계 8대 불가사의"라고 칭했습니다.</p><p class="mt-4 text-muted-foreground">이 계산기는 시간과 이자율이라는 두 날개를 당신의 월별 적금이 눈덩이처럼 불어나는 과정을 명확하게 보여줍니다.</p>',
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">월 복리 적금 공식</h3><div class="space-y-4"><div class="p-4 border-l-4 border-primary bg-muted"><h4 class="font-semibold text-lg mb-2">1. 월초 납입 (선납형)</h4><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>S</mi><mo>=</mo><mi>A</mi><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><mo stretchy="false">)</mo><mo>×</mo><mfrac><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><msup><mo stretchy="false">)</mo><mi>n</mi></msup><mo>−</mo><mn>1</mn></mrow><mi>r</mi></mfrac></mrow><annotation encoding="application/x-tex">S = A \\times (1 + r) \\times \\dfrac{(1+r)^n - 1}{r}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.05764em;">S</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal">A</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose">)</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.113em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.427em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.6644em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">n</span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div></div><div class="p-4 border-l-4 border-primary bg-muted"><h4 class="font-semibold text-lg mb-2">2. 월말 납입 (후납형)</h4><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>S</mi><mo>=</mo><mi>A</mi><mo>×</mo><mfrac><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><msup><mo stretchy="false">)</mo><mi>n</mi></msup><mo>−</mo><mn>1</mn></mrow><mi>r</mi></mfrac></mrow><annotation encoding="application/x-tex">S = A \\times \\dfrac{(1+r)^n - 1}{r}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.05764em;">S</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal">A</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.113em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.427em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.6644em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">n</span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div></div></div>',
  ...
  stockCompoundInterest: {
    ...
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">복리 계산 방식</h3><div class="space-y-4"><ul class="list-decimal list-inside space-y-2"><li><strong>1년차 평가액:</strong><div class="mt-1 bg-card p-2 rounded overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mo stretchy="false">(</mo><mtext>초기 투자금</mtext><mo>+</mo><mtext>월 투자금</mtext><mo>×</mo><mn>12</mn><mo stretchy="false">)</mo><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>연 수익률</mtext><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">(\\text{초기 투자금} + \\text{월 투자금} \\times 12) \\times (1 + \\text{연 수익률})</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord text"><span class="mord hangul_fallback">초기</span><span class="mord"> </span><span class="mord hangul_fallback">투자금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">월</span><span class="mord"> </span><span class="mord hangul_fallback">투자금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord">12</span><span class="mclose">)</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord hangul_fallback">연</span><span class="mord"> </span><span class="mord hangul_fallback">수익률</span></span><span class="mclose">)</span></span></span></span></span></div></li><li><strong>2년차 이후:</strong><div class="mt-1 bg-card p-2 rounded overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mo stretchy="false">(</mo><mtext>전년 평가액</mtext><mo>+</mo><mtext>월 투자금</mtext><mo>×</mo><mn>12</mn><mo stretchy="false">)</mo><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>연 수익률</mtext><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">(\\text{전년 평가액} + \\text{월 투자금} \\times 12) \\times (1 + \\text{연 수익률})</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord text"><span class="mord hangul_fallback">전년</span><span class="mord"> </span><span class="mord hangul_fallback">평가액</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">월</span><span class="mord"> </span><span class="mord hangul_fallback">투자금</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord">12</span><span class="mclose">)</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord hangul_fallback">연</span><span class="mord"> </span><span class="mord hangul_fallback">수익률</span></span><span class="mclose">)</span></span></span></span></span></div></li></ul></div>',
  ...
  salary: {
    ...
    deductions: {
      ...
      fourMajorInsuranceTotal: '4대보험 합계',
      incomeTax: '소득세 (간이세액)',
  ...
  ordinaryWage: {
    ...
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">통상임금 계산 방식</h3><div class="space-y-4"><div class="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 class="text-lg font-bold text-primary mb-3">1. 월 통상임금</h3><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>월 통상임금</mtext><mo>=</mo><mtext>월 기본급</mtext><mo>+</mo><mtext>고정 수당</mtext><mo>+</mo><mfrac><mtext>연간 상여금</mtext><mn>12</mn></mfrac></mrow><annotation encoding="application/x-tex">\\text{월 통상임금} = \\text{월 기본급} + \\text{고정 수당} + \\dfrac{\\text{연간 상여금}}{12}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">월</span><span class="mord"> </span><span class="mord hangul_fallback">통상임금</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">월</span><span class="mord"> </span><span class="mord hangul_fallback">기본급</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">고정</span><span class="mord"> </span><span class="mord hangul_fallback">수당</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.0463em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3603em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord">12</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">연간</span><span class="mord"> </span><span class="mord hangul_fallback">상여금</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div></div><div class="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 class="text-lg font-bold text-primary mb-3">2. 시급 (통상임금)</h3><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>시급</mtext><mo>=</mo><mfrac><mtext>월 통상임금</mtext><mtext>월 소정근로시간</mtext></mfrac></mrow><annotation encoding="application/x-tex">\\text{시급} = \\dfrac{\\text{월 통상임금}}{\\text{월 소정근로시간}}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">시급</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:2.0463em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3603em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">월</span><span class="mord"> </span><span class="mord hangul_fallback">소정근로시간</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord hangul_fallback">월</span><span class="mord"> </span><span class="mord hangul_fallback">통상임금</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><p class="mt-3"><strong>월 소정근로시간:</strong></p><p class="text-sm">주 40시간/5일 근무, 유급주휴(일요일 8시간) 포함 시 평균 <strong>209시간/월</strong></p></div><div class="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 class="text-lg font-bold text-primary mb-3">3. 일급 (통상임금)</h3><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>일급</mtext><mo>=</mo><mtext>시급</mtext><mo>×</mo><mtext>1일 소정근로시간</mtext></mrow><annotation encoding="application/x-tex">\\text{일급} = \\text{시급} \\times \\text{1일 소정근로시간}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord hangul_fallback">일급</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord hangul_fallback">시급</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord text"><span class="mord">1</span><span class="mord hangul_fallback">일</span><span class="mord"> </span><span class="mord hangul_fallback">소정근로시간</span></span></span></span></span></span></div></div></div>',
  ...
  unitConverter: {
    ...
    formulaFormula: '\\text{대상값} = \\text{입력값} \\times \\dfrac{\\text{대상 단위 계수}}{\\text{기준 단위 계수}}',
  ...
  coinFlip: {
    ...
    tips: {
      ...
      items: [
        ...
        { title: '여러 번 던지기', desc: '한 번만으로는 불공평할 수 있으므로 3번이나 5번 중 다수결로 결정하면 더 공정합니다.' },
  ...
  colorPicker: {
    ...
    descriptionContent: {
      ...
      p2: 'HEX(#RRGGBB), RGB(레드, 그린, 블루), HSL(색상, 채도, 명도) 세 가지 주요 색상 포맷을 실시간으로 상호 변환하고 색상 미리보기를 통해 결과를 즉시 확인할 수 있습니다.',
  ...
  dpsCalculator: {
    ...
    formula: {
      baseDpsNoCrit: '기본 DPS (치명타 미적용)',
      baseDpsFormula: '\\text{기본 DPS} = \\text{공격력} \\times \\text{공격속도(APS)}',
      critCoefficient: '치명타 계수',
      critFormula: '\\text{치명타 계수} = 1 + \\dfrac{\\text{치명타확률}}{100} \\times (\\text{치명타배율} - 1)',
      critDps: '치명타 적용 DPS',
      critDpsFormula: '\\text{DPS} = \\text{공격력} \\times \\text{APS} \\times \\text{치명타 계수}',
      buffedDps: '버프 적용 DPS',
      buffedFormula: '\\text{버프 DPS} = \\text{공격력} \\times \\left(1 + \\dfrac{\\text{추가데미지\\%}}{100}\\right) \\times \\text{APS} \\times \\left(1 + \\dfrac{\\text{공격속도\\%}}{100}\\right) \\times \\text{치명타 계수}',
    ...
    howToUse: {
      title: '사용 방법',
      step1: '무기 또는 도구의 데미지를 입력합니다.',
      step2: '공격 속도(APS) 또는 쿨다운을 입력합니다.',
      step3: '지원되는 경우 치명타 확률과 치명타 배율을 설정합니다.',
      step4: '계산 버튼을 눌러 DPS를 확인합니다.',
    },
    workedExamples: {
      title: '계산 예시',
      ex1: '데미지 100 × 초당 2회 공격 = 200 DPS',
      ex2: '데미지 500, 쿨다운 2.5초 = 200 DPS',
      ex3: '치명타 확률 50%, 치명타 배율 2배: 유효 DPS 50% 증가',
    },
    faq: {
      title: '자주 묻는 질문',
      items: [
        { q: 'DPS가 무엇인가요?', a: 'DPS(Damage Per Second)는 1초 동안 가하는 평균 데미지로, 캐릭터나 무기의 전투력을 비교하는 핵심 지표입니다.' },
        { q: '공격 속도는 DPS와 어떤 관계인가요?', a: 'DPS = 데미지 × 공격 횟수이므로 공격 속도가 빠를수록 DPS가 비례하여 증가합니다. 느리고 강한 무기도 DPS는 같을 수 있습니다.' },
        { q: '치명타는 DPS 계산에 어떤 영향을 주나요?', a: '치명타 확률과 배율을 반영해 기대 DPS가 계산됩니다. 예를 들어 50% 확률에 2배 배율이면 유효 DPS가 약 50% 증가합니다.' },
        { q: '폭딜(순간 데미지)과 지속 DPS는 왜 다른가요?', a: '폭딜은 짧은 순간의 큰 데미지이고, DPS는 시간 평균입니다. 쿨다운이 긴 무기는 순간 폭딜이 커도 지속 DPS는 낮을 수 있습니다.' },
        { q: 'DPS로 다른 무기를 어떻게 비교하나요?', a: '같은 조건(치명타, 버프)으로 계산한 DPS를 비교하면 됩니다. 다만 방어력, 무적, 사거리 등 실전 요인은 반영되지 않으므로 참고용으로 활용하세요.' },
      ],
    },
  },
  ...
  randomNumberGenerator: {
    ...
    info: {
      ...
      p2: '무작위 번호 생성, 경품 추첨, A/B 테스트 샘플 추출, 시뮬레이션용 난수, 게임 이벤트 확률 검증 등 다양한 상황에서 활용됩니다.',
      p3: '개발자와 데이터 분석가에게는 테스트 데이터 생성 도구로, 이벤트 운영자와 교육자에게는 공정한 추첨 도구로 유용합니다. 최근 10회 생성 기록도 함께 제공됩니다.',
      tip: '생성에는 Math.random()을 사용하며 통계적으로 균등한 분포를 가집니다. 단, 보안이 필요한 난수(공식 추첨 등)에는 암호학적 난수 생성기를 별도로 사용하세요. 기록은 브라우저 세션 동안만 유지됩니다.',
    },
    formula: {
    ...
    tips: {
      randomSelection: '무작위 추출',
      randomSelectionTip1: '중복 불가와 오름차순 정렬을 사용하세요.',
      randomSelectionTip2: '용도에 맞게 범위와 개수를 설정하세요.',
      fairDrawing: '공정한 추첨',
      fairTip1: '중복 허용으로 여러 번 뽑기 시나리오를 만들 수 있습니다.',
      fairTip2: '추첨 전 범위를 참가자에게 공개하세요.',
      testData: '테스트 데이터',
      ...
      secureRandom: '보안 난수',
      secureTip1: '공인된 추첨·인증 용도에는 부적합합니다.',
  ...
  internetSpeedTest: {
    ...
    formula: {
      ...
      pingFormula: 'Ping = \\dfrac{\\text{왕복 시간(RTT)}}{2}',
      download: '다운로드 속도',
      downloadDesc: '일정량의 데이터를 받는 데 걸린 시간으로 속도를 계산합니다.',
      downloadFormula: '\\text{속도(Mbps)} = \\dfrac{\\text{데이터량} \\times 8}{\\text{시간(초)}} \\div 1{,}000{,}000',
      uploadJitter: '업로드 속도와 지터',
      uploadFormula: '\\text{업로드 속도} = \\dfrac{\\text{전송량} \\times 8}{\\text{시간(초)}} \\div 1{,}000{,}000',
  ...
  morseCode: {
    title: '모스 부호 변환기',
    description: '텍스트와 국제 모스 부호를 상호 변환합니다',
    textToMorse: '텍스트 \u2192 모스',
    morseToText: '모스 \u2192 텍스트',
