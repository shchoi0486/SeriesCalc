export const en = {
  common: {
    ...
    beamDeflection: {
      ...
      units: {
        load: 'Load Unit',
        length: 'Length Unit',
        elasticity: 'Elasticity Unit',
        inertia: 'Inertia Unit',
        deflection: 'Deflection Unit',
      },
      details: {
    ...
    heatTransfer: {
      ...
      units: {
        area: 'Area Unit',
        thickness: 'Thickness Unit',
        conductivity: 'Conductivity Unit',
        temp: 'Temperature Unit',
        heatRate: 'Heat Rate Unit',
        heatFlux: 'Heat Flux Unit',
      },
      details: {
        title: '📚 Fourier\'s Law',
    ...
    reynoldsNumber: {
      ...
      visualization: {
        ...
        regimeBar: 'Reynolds Number Scale (log)',
        laminarZone: 'Laminar',
        transitionalZone: 'Transitional',
        turbulentZone: 'Turbulent',
        currentPosition: 'Current Re',
        flowDiagram: 'Flow Pattern',
      },
      units: {
        density: 'Density Unit',
        velocity: 'Velocity Unit',
        diameter: 'Diameter Unit',
        viscosity: 'Viscosity Unit',
        kgm3: 'kg/m³',
        lbft3: 'lb/ft³',
        gcm3: 'g/cm³',
        ms: 'm/s',
    ...
    bearingLife: {
      ...
      visualization: {
        ...
        caption: 'Blue curve: bearing life in hours (L10h) falls as load rises. Red dot: your current operating point — its height equals the L10h result.',
      },
      details: {
  ...
  calculatorNames: {
    ...
    'dsr-calculator': 'DSR Calculator',
    'amortization-schedule': 'Amortization Schedule',
    'auto-loan-calculator': 'Auto Loan Calculator',
    'jeonse-deposit-calculator': 'Jeonse Deposit Loan Limit',
    'charter-loan-calculator': 'Charter Loan Calculator',
    'net-salary-calculator': 'Net Salary Calculator',
    'salary-calculator': 'Salary Converter',
    'income-tax-calculator': 'Income Tax Calculator',
    'inflation-calculator': 'Inflation Calculator',
    'interest-rate-calculator': 'Interest Rate Converter',
    'korean-shoe-size-converter': 'Korean Shoe Size Converter',
    'korean-clothing-size-converter': 'Korean Clothing Size Converter',
    ...
    'gpa-calculator': 'GPA Calculator (Korea 4.5)',
    ...
    'korean-wind-load': 'Korean Wind Load Calculator (KDS)',
    'subnet-calculator': 'Subnet Calculator',
    'pressure-converter': 'Pressure Unit Converter',
    'flow-rate-converter': 'Flow Rate Unit Converter',
    'water-density': 'Water Density Calculator',
    'specific-gravity': 'Specific Gravity Calculator',
    'pipe-sizing': 'Pipe Sizing Calculator',
    'wire-gauge': 'Wire Gauge (AWG) Calculator',
    'moment-of-inertia': 'Moment of Inertia Calculator',
    'heat-capacity': 'Heat Capacity Calculator',
    'dew-point': 'Dew Point Calculator',
    'convection-heat-transfer': 'Convection Heat Transfer Calculator',
  },
  calculatorDescriptions: {
    ...
    'pressure-converter': 'Convert between pressure units including Pa, bar, atm, psi, mmHg, and more.',
    'flow-rate-converter': 'Convert between flow rate units including m³/h, L/min, gal/min, CFM, and more.',
    'water-density': 'Calculate water density, specific weight, and viscosity as a function of temperature.',
    'specific-gravity': 'Calculate the specific gravity of a substance relative to water.',
    'pipe-sizing': 'Determine the optimal pipe diameter based on flow rate and maximum velocity.',
    'wire-gauge': 'Look up AWG wire gauge dimensions, area, and resistance per unit length.',
    'moment-of-inertia': 'Calculate the second moment of area (moment of inertia) for various cross-sections.',
    'heat-capacity': 'Calculate the heat energy required to change the temperature of a substance.',
    'dew-point': 'Calculate dew point, wet bulb temperature, and absolute humidity from dry bulb temperature and relative humidity.',
    'convection-heat-transfer': 'Calculate the convection heat transfer coefficient using Reynolds and Nusselt numbers.',
  },
  calculatorLayout: {
...
<div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Monthly Principal</mtext><mo>=</mo><mfrac><mi>P</mi><mi>n</mi></mfrac></mrow><annotation encoding="application/x-tex">\\text{Monthly Principal} = \\dfrac{P}{n}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Monthly Principal</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:2.0463em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3603em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal">n</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.13889em;">P</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Monthly Interest</mtext><mo>=</mo><mtext>Remaining Balance</mtext><mo>×</mo><mi>r</mi></mrow><annotation encoding="application/x-tex">\\text{Monthly Interest} = \\text{Remaining Balance} \\times r</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Monthly Interest</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Remaining Balance</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span></span></span></div>
...
<div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Monthly Interest</mtext><mo>=</mo><mi>P</mi><mo>×</mo><mi>r</mi></mrow><annotation encoding="application/x-tex">\\text{Monthly Interest} = P \\times r</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Monthly Interest</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal" style="margin-right:0.13889em;">P</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span></span></span></div>
...
<p class="mt-4 text-muted-foreground"><strong class="text-foreground">SeriesCalc's Early Repayment Fee Calculator</strong> is a powerful tool to help you make informed decisions. Beyond simply calculating the fee, it helps you weigh the pros and cons of different repayment timings and develop an optimal financial strategy to avoid unnecessary expenses.</p>`,
...
<div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Estimated Fee</mtext><mo>=</mo><mtext>Early Repayment Principal</mtext><mo>×</mo><mtext>Fee Rate</mtext><mo>×</mo><mfrac><mtext>Remaining Days</mtext><mtext>Fee Period</mtext></mfrac></mrow><annotation encoding="application/x-tex">\\text{Estimated Fee} = \\text{Early Repayment Principal} \\times \\text{Fee Rate} \\times \\dfrac{\\text{Remaining Days}}{\\text{Fee Period}}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6944em;"></span><span class="mord text"><span class="mord">Estimated Fee</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Early Repayment Principal</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord">Fee Rate</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.0463em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3603em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">Fee Period</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">Remaining Days</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div>
</div>
...
<p class="text-muted-foreground">This calculator uses the standard sliding method as a baseline, but the actual fee rate, calculation method, and exemption conditions are defined in your <strong class="text-foreground">loan agreement</strong>. Always review your agreement before executing any repayment and contact your lender with questions.</p>
  ...
  installmentInterest: {
    ...
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">How Is Installment Interest Calculated?</h3><p class="text-muted-foreground">The Equal Principal & Interest method means your monthly payment stays the same throughout the installment period. Each payment consists of principal and interest — early payments are interest-heavy, while the principal portion grows over time.</p><div class="p-6 bg-card rounded-lg my-4 border border-border"><h4 class="text-lg font-semibold mb-3 text-foreground">Monthly Payment Formula</h4><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Monthly Payment</mtext><mo>=</mo><mfrac><mrow><mtext>Principal</mtext><mo>×</mo><mtext>Monthly Rate</mtext><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>Monthly Rate</mtext><msup><mo stretchy="false">)</mo><mtext>Months</mtext></msup></mrow><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>Monthly Rate</mtext><msup><mo stretchy="false">)</mo><mtext>Months</mtext></msup><mo>−</mo><mn>1</mn></mrow></mfrac></mrow><annotation encoding="application/x-tex">\\text{Monthly Payment} = \\dfrac{\\text{Principal} \\times \\text{Monthly Rate} \\times (1 + \\text{Monthly Rate})^{\\text{Months}}}{(1 + \\text{Monthly Rate})^{\\text{Months}} - 1}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Monthly Payment</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:2.4621em;vertical-align:-0.936em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.5261em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord">Monthly Rate</span></span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.7751em;"><span style="top:-2.989em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord text mtight"><span class="mord mtight">Months</span></span></span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">Principal</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord">Monthly Rate</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord">Monthly Rate</span></span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.8491em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord text mtight"><span class="mord mtight">Months</span></span></span></span></span></span></span></span></span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.936em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Total Interest</mtext><mo>=</mo><mo stretchy="false">(</mo><mtext>Monthly Payment</mtext><mo>×</mo><mtext>Months</mtext><mo stretchy="false">)</mo><mo>−</mo><mtext>Principal</mtext></mrow><annotation encoding="application/x-tex">\\text{Total Interest} = (\\text{Monthly Payment} \\times \\text{Months}) - \\text{Principal}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6944em;"></span><span class="mord text"><span class="mord">Total Interest</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord text"><span class="mord">Monthly Payment</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord">Months</span></span><span class="mclose">)</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Principal</span></span></span></span></span></span></div></div><div class="p-6 bg-muted rounded-lg border border-border"><h4 class="text-lg font-semibold mb-3 text-foreground">Worked Example</h4><p class="text-muted-foreground">Buying a 1M KRW laptop at 12% annual interest over 12 months:</p><ul class="list-decimal list-inside space-y-2 mt-3 text-sm text-muted-foreground"><li><strong class="text-foreground">Principal:</strong> 1,000,000 KRW</li><li><strong class="text-foreground">Monthly Rate:</strong> 12% / 12 = 1% (0.01)</li><li><strong class="text-foreground">Monthly Payment:</strong> ≈ 88,849 KRW</li><li><strong class="text-foreground">Total Repayment:</strong> 88,849 × 12 = 1,066,188 KRW</li><li><strong class="text-foreground">Total Interest:</strong> 1,066,188 − 1,000,000 = 66,188 KRW</li></ul></div>',
  ...
  compoundInterest: {
    ...
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">How Does Compound Interest Calculation Work?</h3><div class="space-y-4"><div class="p-4 border-l-4 border-primary bg-muted"><h4 class="font-semibold text-lg mb-2">1. Lump-Sum Investment (No Monthly Deposits)</h4><p class="mb-2">When you only invest the initial amount with no additional contributions.</p><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>F</mi><mi>V</mi><mo>=</mo><mi>P</mi><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><msup><mo stretchy="false">)</mo><mi>n</mi></msup></mrow><annotation encoding="application/x-tex">FV = P \\times (1 + r)^n</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.13889em;">F</span><span class="mord mathnormal" style="margin-right:0.22222em;">V</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal" style="margin-right:0.13889em;">P</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.7144em;"><span style="top:-3.113em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">n</span></span></span></span></span></span></span></span></span></span></span></span></div><p class="text-sm text-muted-foreground">- P: Initial principal<br/>- r: Monthly rate (annual rate ÷ 12)<br/>- n: Total months</p></div><div class="p-4 border-l-4 border-primary bg-muted"><h4 class="font-semibold text-lg mb-2">2. Regular Savings (With Monthly Deposits)</h4><p class="mb-2">When you add a fixed amount each month, compound interest effects are maximized. This calculator supports both beginning-of-month and end-of-month deposits.</p><div class="my-2 overflow-x-auto"><p class="mb-1 text-sm"><strong>Beginning of Month:</strong></p><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>F</mi><mi>V</mi><mo>=</mo><mtext>Lump-Sum FV</mtext><mo>+</mo><mi>M</mi><mo>×</mo><mfrac><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><msup><mo stretchy="false">)</mo><mi>n</mi></msup><mo>−</mo><mn>1</mn></mrow><mi>r</mi></mfrac><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">FV = \\text{Lump-Sum FV} + M \\times \\dfrac{(1+r)^n - 1}{r} \\times (1+r)</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.13889em;">F</span><span class="mord mathnormal" style="margin-right:0.22222em;">V</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8778em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Lump-Sum FV</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal" style="margin-right:0.10903em;">M</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.113em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.427em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.6644em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">n</span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose">)</span></span></span></span></span></div><div class="my-2 overflow-x-auto"><p class="mb-1 text-sm"><strong>End of Month:</strong></p><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>F</mi><mi>V</mi><mo>=</mo><mtext>Lump-Sum FV</mtext><mo>+</mo><mi>M</mi><mo>×</mo><mfrac><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><msup><mo stretchy="false">)</mo><mi>n</mi></msup><mo>−</mo><mn>1</mn></mrow><mi>r</mi></mfrac></mrow><annotation encoding="application/x-tex">FV = \\text{Lump-Sum FV} + M \\times \\dfrac{(1+r)^n - 1}{r}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.13889em;">F</span><span class="mord mathnormal" style="margin-right:0.22222em;">V</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8778em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Lump-Sum FV</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal" style="margin-right:0.10903em;">M</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.113em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.427em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.6644em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">n</span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><p class="text-sm text-muted-foreground">Depositing at the beginning earns one extra month of interest, resulting in a slightly higher final amount. The difference grows significantly over longer investment periods.</p></div></div>',
  ...
  installmentSavingsMonthly: {
    ...
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">Monthly Compound Savings Formulas</h3><div class="space-y-4"><div class="p-4 border-l-4 border-primary bg-muted"><h4 class="font-semibold text-lg mb-2">1. Beginning of Month (Annuity Due)</h4><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>S</mi><mo>=</mo><mi>A</mi><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><mo stretchy="false">)</mo><mo>×</mo><mfrac><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><msup><mo stretchy="false">)</mo><mi>n</mi></msup><mo>−</mo><mn>1</mn></mrow><mi>r</mi></mfrac></mrow><annotation encoding="application/x-tex">S = A \\times (1 + r) \\times \\dfrac{(1+r)^n - 1}{r}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.05764em;">S</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal">A</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose">)</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.113em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.427em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.6644em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">n</span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><p class="text-sm text-muted-foreground">Depositing at the beginning of the month earns one extra month of interest.</p></div><div class="p-4 border-l-4 border-primary bg-muted"><h4 class="font-semibold text-lg mb-2">2. End of Month (Ordinary Annuity)</h4><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>S</mi><mo>=</mo><mi>A</mi><mo>×</mo><mfrac><mrow><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mi>r</mi><msup><mo stretchy="false">)</mo><mi>n</mi></msup><mo>−</mo><mn>1</mn></mrow><mi>r</mi></mfrac></mrow><annotation encoding="application/x-tex">S = A \\times \\dfrac{(1+r)^n - 1}{r}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal" style="margin-right:0.05764em;">S</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.7667em;vertical-align:-0.0833em;"></span><span class="mord mathnormal">A</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.113em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.427em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord mathnormal" style="margin-right:0.02778em;">r</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">r</span><span class="mclose"><span class="mclose">)</span><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.6644em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">n</span></span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">−</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord">1</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div></div><div class="mt-4 text-sm text-muted-foreground"><p><strong>S</strong>: Total maturity amount (principal + interest)</p><p><strong>A</strong>: Monthly deposit amount</p><p><strong>r</strong>: Monthly interest rate (annual rate / 12)</p><p><strong>n</strong>: Total number of months</p></div></div>',
  ...
  stockCompoundInterest: {
    ...
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">How Compound Interest Works</h3><div class="space-y-4"><p>This calculator assumes returns are reinvested at year-end, and annual contributions are added at the beginning of each year.</p><ul class="list-decimal list-inside space-y-2"><li><strong>Year 1 Valuation:</strong><div class="mt-1 bg-card p-2 rounded overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mo stretchy="false">(</mo><mtext>Initial Investment</mtext><mo>+</mo><mtext>Monthly Investment</mtext><mo>×</mo><mn>12</mn><mo stretchy="false">)</mo><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>Annual Return</mtext><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">(\\text{Initial Investment} + \\text{Monthly Investment} \\times 12) \\times (1 + \\text{Annual Return})</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord text"><span class="mord">Initial Investment</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Monthly Investment</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord">12</span><span class="mclose">)</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord">Annual Return</span></span><span class="mclose">)</span></span></span></span></span></div></li><li><strong>Year 2+ Valuation:</strong><div class="mt-1 bg-card p-2 rounded overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mo stretchy="false">(</mo><mtext>Previous Year Valuation</mtext><mo>+</mo><mtext>Monthly Investment</mtext><mo>×</mo><mn>12</mn><mo stretchy="false">)</mo><mo>×</mo><mo stretchy="false">(</mo><mn>1</mn><mo>+</mo><mtext>Annual Return</mtext><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">(\\text{Previous Year Valuation} + \\text{Monthly Investment} \\times 12) \\times (1 + \\text{Annual Return})</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord text"><span class="mord">Previous Year Valuation</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Monthly Investment</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord">12</span><span class="mclose">)</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen">(</span><span class="mord">1</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord text"><span class="mord">Annual Return</span></span><span class="mclose">)</span></span></span></span></span></div></li></ul><div class="mt-4 text-sm text-muted-foreground"><p><strong>Initial Investment:</strong> Seed money — the larger it is, the sooner and greater the compound effect.</p><p><strong>Monthly Investment:</strong> The power of dollar-cost averaging. Consistency creates the extraordinary.</p><p><strong>Annual Return:</strong> The engine that grows your assets. S&P 500 historical average is ~10-12%, but this varies.</p><p><strong>Investment Period:</strong> The most important factor. The longer the period, the faster returns generate more returns.</p></div></div>',
  ...
  salary: {
    ...
    deductions: {
      ...
      fourMajorInsuranceTotal: '4 Major Insurances Total',
  ...
  ordinaryWage: {
    ...
    formulaContent: '<h3 class="text-lg font-semibold mt-6 mb-3 text-foreground">How Ordinary Wage Is Calculated</h3><div class="space-y-4"><div class="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 class="text-lg font-bold text-primary mb-3">1. Monthly Ordinary Wage</h3><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Monthly Ordinary Wage</mtext><mo>=</mo><mtext>Base Salary</mtext><mo>+</mo><mtext>Fixed Allowances</mtext><mo>+</mo><mfrac><mtext>Annual Bonuses</mtext><mn>12</mn></mfrac></mrow><annotation encoding="application/x-tex">\\text{Monthly Ordinary Wage} = \\text{Base Salary} + \\text{Fixed Allowances} + \\dfrac{\\text{Annual Bonuses}}{12}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Monthly Ordinary Wage</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Base Salary</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.7778em;vertical-align:-0.0833em;"></span><span class="mord text"><span class="mord">Fixed Allowances</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.0574em;vertical-align:-0.686em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3714em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord">12</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">Annual Bonuses</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><p class="text-xs text-muted-foreground mt-2">Not all allowances and bonuses are included — they must meet the criteria (regularity, universality, fixedness) explained below.</p></div><div class="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 class="text-lg font-bold text-primary mb-3">2. Hourly Ordinary Wage (Most Basic!)</h3><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Hourly Ordinary Wage</mtext><mo>=</mo><mfrac><mtext>Monthly Ordinary Wage</mtext><mtext>Standard Monthly Hours</mtext></mfrac></mrow><annotation encoding="application/x-tex">\\text{Hourly Ordinary Wage} = \\dfrac{\\text{Monthly Ordinary Wage}}{\\text{Standard Monthly Hours}}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Hourly Ordinary Wage</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:2.2519em;vertical-align:-0.8804em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3714em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">Standard Monthly Hours</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">Monthly Ordinary Wage</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.8804em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><p class="mt-3"><strong>Monthly Standard Working Hours:</strong></p><p class="text-sm">For 40-hour/5-day work weeks, including paid weekly leave (8 hours Sunday), the average is <strong>209 hours/month</strong>.</p></div><div class="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 class="text-lg font-bold text-primary mb-3">3. Daily Ordinary Wage</h3><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Daily Ordinary Wage</mtext><mo>=</mo><mtext>Hourly Ordinary Wage</mtext><mo>×</mo><mtext>Daily Working Hours</mtext></mrow><annotation encoding="application/x-tex">\\text{Daily Ordinary Wage} = \\text{Hourly Ordinary Wage} \\times \\text{Daily Working Hours}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Daily Ordinary Wage</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Hourly Ordinary Wage</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Daily Working Hours</span></span></span></span></span></span></div></div></div>',
  ...
  retirement: {
    ...
    formulaContent: '<p className="font-semibold">Severance pay is calculated based on the "daily average wage" in proportion to "total days of employment." It\'s important to accurately understand the two key calculation elements.</p><div className="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 className="text-lg font-bold text-primary mb-3">1. Daily Average Wage Calculation</h3><p>The total wages paid during the 3 months before the retirement date divided by the total number of days in that period. This includes not only base salary but also overtime, night, holiday work allowances, and various other allowances.</p><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Daily Average Wage</mtext><mo>=</mo><mfrac><mrow><mtext>Total wages for 3 months</mtext><mo>+</mo><mtext>Annual bonus</mtext><mo>×</mo><mstyle displaystyle="false" scriptlevel="0"><mfrac><mn>3</mn><mn>12</mn></mfrac></mstyle><mo>+</mo><mtext>Leave allowance</mtext><mo>×</mo><mstyle displaystyle="false" scriptlevel="0"><mfrac><mn>3</mn><mn>12</mn></mfrac></mstyle></mrow><mtext>Total days in 3 months</mtext></mfrac></mrow><annotation encoding="application/x-tex">\\text{Daily Average Wage} = \\dfrac{\\text{Total wages for 3 months} + \\text{Annual bonus} \\times \\tfrac{3}{12} + \\text{Leave allowance} \\times \\tfrac{3}{12}}{\\text{Total days in 3 months}}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Daily Average Wage</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:2.4605em;vertical-align:-0.8804em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.5801em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">Total days in 3 months</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.735em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">Total wages for 3 months</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord">Annual bonus</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.8451em;"><span style="top:-2.655em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">12</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.394em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">3</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.345em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">+</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord text"><span class="mord">Leave allowance</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.8451em;"><span style="top:-2.655em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">12</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.394em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">3</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.345em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.8804em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><p className="text-xs text-muted-foreground dark:text-muted-foreground mt-2">* Allowances and annual leave allowances paid on an annual basis are converted to 3 months and included.</p><p className="text-xs text-primary mt-2">* If the daily average wage is less than the ordinary wage, the ordinary wage must be used as the daily average wage for calculation.</p></div><div className="p-4 bg-muted rounded-lg border-l-4 border-primary"><h3 className="text-lg font-bold text-primary mb-3">2. Estimated Severance Pay Calculation</h3><p>The calculated daily average wage is multiplied by 30 to get the "30-day average wage," which is then proportionally applied to the total employment period to calculate the final severance pay.</p><div class="my-2 overflow-x-auto"><span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mtext>Estimated Severance Pay</mtext><mo>=</mo><mtext>Daily Average Wage</mtext><mo>×</mo><mtext>30 days</mtext><mo>×</mo><mfrac><mtext>Employment days</mtext><mtext>365 days</mtext></mfrac></mrow><annotation encoding="application/x-tex">\\text{Estimated Severance Pay} = \\text{Daily Average Wage} \\times \\text{30 days} \\times \\dfrac{\\text{Employment days}}{\\text{365 days}}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Estimated Severance Pay</span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">Daily Average Wage</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord text"><span class="mord">30 days</span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">×</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:2.2519em;vertical-align:-0.8804em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3714em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">365 days</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord text"><span class="mord">Employment days</span></span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.8804em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span></span></span></span></span></div><div className="mt-4 p-4 bg-muted rounded-lg border border-border"><h4 className="font-semibold text-foreground mb-2">Calculation Example (Daily Average Wage 100,000 KRW, 5 years of service)</h4><p className="text-sm text-muted-foreground">Total days of employment = 365 × 5 = 1,825 days</p><p className="font-mono text-sm text-primary mt-1">Estimated Severance Pay = 100,000 × 30 × (1,825 / 365) = 100,000 × 30 × 5 = 15,000,000 KRW</p></div></div>',
  ...
  unitConverter: {
    ...
    formulaFormula: '\\text{Target Value} = \\text{Input Value} \\times \\dfrac{\\text{Target Unit Coefficient}}{\\text{Reference Unit Coefficient}}',
  ...
  dpsCalculator: {
    ...
    info: {
      ...
      p3: 'Useful for general users as a build design and growth guide, and for strategy writers and guild managers as an analysis tool for party composition.',
    ...
    formula: {
      baseDpsNoCrit: 'Base DPS (No Crit)',
      baseDpsFormula: '\\text{Base DPS} = \\text{Attack Power} \\times \\text{Attack Speed (APS)}',
      critCoefficient: 'Crit Coefficient',
      critFormula: '\\text{Crit Coefficient} = 1 + \\dfrac{\\text{Crit Chance}}{100} \\times (\\text{Crit Multiplier} - 1)',
      critDps: 'Crit Applied DPS',
      critDpsFormula: '\\text{DPS} = \\text{Attack Power} \\times \\text{APS} \\times \\text{Crit Coefficient}',
      buffedDps: 'Buffed DPS',
      buffedFormula: '\\text{Buffed DPS} = \\text{Attack Power} \\times \\left(1 + \\dfrac{\\text{Bonus Damage\\%}}{100}\\right) \\times \\text{APS} \\times \\left(1 + \\dfrac{\\text{Attack Speed\\%}}{100}\\right) \\times \\text{Crit Coefficient}',
    ...
    howToUse: {
      title: 'How to Use',
      step1: 'Enter the damage of your weapon or tool.',
      step2: 'Enter the attack speed (APS) or cooldown.',
      step3: 'Set crit chance and crit multiplier if supported.',
      step4: 'Press calculate to see your DPS.',
    },
    workedExamples: {
      title: 'Worked Examples',
      ex1: '100 damage × 2 attacks/sec = 200 DPS',
      ex2: '500 damage with 2.5s cooldown = 200 DPS',
      ex3: 'With 50% crit chance and 2x crit damage: effective DPS increases by 50%',
    },
    faq: {
      title: 'Frequently Asked Questions',
      items: [
        { q: 'What does DPS mean?', a: 'DPS (Damage Per Second) is the average damage dealt per second, a key metric for comparing the combat power of characters or weapons.' },
        { q: 'How does attack speed relate to DPS?', a: 'Since DPS = damage × attacks per second, a faster attack speed increases DPS proportionally. A slow, heavy weapon can still have the same DPS.' },
        { q: 'How does crit affect DPS?', a: 'Expected DPS is calculated by factoring in crit chance and multiplier. For example, a 50% chance with a 2x multiplier raises effective DPS by about 50%.' },
        { q: 'Why does burst damage differ from sustained DPS?', a: 'Burst damage is the large damage dealt in a short moment, while DPS is the time average. A weapon with a long cooldown can have high burst but low sustained DPS.' },
        { q: 'How do I compare different weapons using DPS?', a: 'Compare DPS calculated under the same conditions (crit, buffs). Keep in mind factors like defense, invincibility, and range are not reflected, so use it as a reference.' },
      ],
    },
  },
  ...
  randomNumberGenerator: {
    ...
    info: {
      title: 'Random Number Generator',
      p1: 'A tool that picks random numbers within a specified range. Set min, max, count, and choose duplicate/sort options to create numbers for drawings, sampling, test data, and more.',
      p2: 'Useful for random number generation, prize draws, A/B test sampling, simulation random numbers, and game event probability verification.',
      ...
      tip: 'Generation uses Math.random() for statistically uniform distribution. For security-critical random numbers (official draws, etc.), use a cryptographic random number generator separately. Records are maintained only during the browser session.',
    },
    formula: {
    ...
    tips: {
      ...
      randomSelectionTip1: 'Use no duplicates and ascending sort.',
      randomSelectionTip2: 'Set range and count for your specific need.',
      fairDrawing: 'Fair Drawing',
      fairTip1: 'Allow duplicates to create multiple-draw scenarios.',
      fairTip2: 'Announce the range to participants before the draw.',
      testData: 'Test Data',
  ...
  internetSpeedTest: {
    ...
    formula: {
      ...
      pingFormula: 'Ping = \\dfrac{\\text{Round-trip Time (RTT)}}{2}',
      download: 'Download Speed',
      downloadDesc: 'Calculates speed based on time to receive a certain amount of data.',
      downloadFormula: '\\text{Speed (Mbps)} = \\dfrac{\\text{Data} \\times 8}{\\text{Time (s)}} \\div 1{,}000{,}000',
      uploadJitter: 'Upload Speed and Jitter',
      uploadFormula: '\\text{Upload Speed} = \\dfrac{\\text{Data Transferred} \\times 8}{\\text{Time (s)}} \\div 1{,}000{,}000',
